<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="00scales.aspx.cs" Inherits="stevedore_set_tranunits_shipper" %>
    ...
    <div class="container-fluid text-center">
         ...
         <div class="row" >
                 <div class="col-sm-3">
                    ...
                    <asp:HyperLink CssClass="btn btn-default btn-lg btn-xl btn-block" ID="hLscale0"  runat="server">
                        <i class="fas fa-arrow-left"></i>  
                    <br />
                        <asp:Literal ID="scale0Text" runat="server">
                        </asp:Literal>
                    </asp:HyperLink>
                 ...
                 <div class="col-sm-3 col-sm-offset-6">
                     <asp:HyperLink CssClass="btn btn-default btn-lg btn-xl btn-block" ID="hLscale1"  runat="server">
                        <i class="fas fa-arrow-right"></i>
                    <br />
                        <asp:Literal ID="scale1Text" runat="server">
                        </asp:Literal>
                    </asp:HyperLink>
